...
| 2026-09-08 | Approved storage lifecycle protocol 2 | Phase 3C implementation in progress; not activated | The operator approved the exact lifecycle proposal. v36 introduces bounded unfinished intents and exact independently claimed physical debt, with backend/shard transaction parity and move-only I/O ownership. Fifteen focused tests pass. Production blob/publication/quota/recovery integration and final correctness/CI gates remain outstanding. Full scans remain mandatory; no journal-coverage or activation claim follows from these foundation tests. |
